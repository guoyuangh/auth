...
class BootstrapDetailed extends Paginator
{
    ...
    protected function gopage()
    {
        ...
        $html = <<<HTML
<li  style="float:left;margin-left: 10px;"><form style="margin-top: 2px;">
<input type="text" style="width:80px;height:30px;outline: none;padding-left: 2px;border-radius: 3px;border:1px solid #ccc;" autocomplete="off" name="$page" placeholder="请输入页数">
